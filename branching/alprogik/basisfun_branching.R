...
xl<-vonalfun[[branchwhich]]$V3(t2)
yl<-vonalfun[[branchwhich]]$V4(t2)
zl<-vonalfun[[branchwhich]]$V5(t2)
...
integralt<-integrate(Vectorize(fun), 0-2*R,max(comp.place[[branchwhich]])+2*R)
