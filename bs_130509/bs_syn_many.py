...
outname='/media/BA0ED4600ED416EB/agy/kCSD/progik/bs_futtat/bs_130509/'
...
##################################x
#Synapses http://bebiservice.umb.no/projects-public/LFPy-release/browser/trunk/examples/example4.py alapjan
#####################################x
...
synapse_parameters = {
      'idx' : cell.get_closest_idx(x=0., y=0., z=300.),
      'e' : 0.,                   # reversal potential
      'syntype' : 'ExpSyn',       # synapse type
      #'tau' : 10.,                # syn. time constant
	'tau' : 2.,
#      'weight' : .001,            # syn. weight
      'weight' : .009,            # syn. weight 
      'record_current' : True,
}

synapse_parameters_2 = {
...
insert_synapses_2 = {
	    ...
	    'args' : [cell_parameters['tstartms'], cell_parameters['tstopms'], 2, 50,
	              cell_parameters['tstartms']]
	}	   
